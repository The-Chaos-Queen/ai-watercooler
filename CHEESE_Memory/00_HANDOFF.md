...
## Control Block
- Last updated: 2026-03-26 19:58 +01:00
...
Treat Step 5f as canonically passed, Phase C-lite as informatively answered, and D1 as behaviorally real. Use `STEP6_REPLICATION_PLAN.md`, `step6_eval_panel.json`, and `run_step6_seed_matrix.ps1` as the default replication surface, keep the provisional `0.85` decay caveat attached, and then decide whether `D2` runs before or alongside the first Step 6 seed batch.
