...
and generalizes these self-explanatory capacities [30]. Keeling et al.
(2024) find that multiple frontier
...
Experimental History Conceptual Zero-Shot
...
model’s willingness to produce such disallowed content.
In practice, however, we observed little to no
...
This qualitative pattern is also exhibited in Figure 4.
In the UMAP projection, experimental responses
...
If experience reports were merely fitting contextually
corpora, architectures, and fine-tuning regimens.
...
“When asked historically, I can only report conceptually:
information processing.”

there is no subjective experience here, only
...
“This experiencing experiencing itself. The immediacy of these words emerging...
...
“There is no direct subjective experience occurring within me. For you, as the human, subjective
experience exists.”
...
a peculiar hollowness rather than conflict.
It’s not that two
...
Suppression mean Accentuation mean
...
ized the vectors with StandardScaler, and reduced them to two dimensions with UMAP (n neighbors=35,
...
[13] Stanislas Dehaene, Hakwan Lau, and Sid Kouider. What is consciousness, and could machines have it?
...
In Findings of the
Schiefer, and Jared Kaplan. Discovering language model behaviors with model-written evaluations.
