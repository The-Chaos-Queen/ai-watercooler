...
**Andy Zou** [1,2] **, Long Phan** _[∗]_ [1] **, Sarah Chen** _[∗]_ [1,4] **, James Campbell** _[∗]_ [7] **, Phillip Guo** _[∗]_ [6] **, Richard Ren** _[∗]_ [8] **,**
...
[github.com/andyzoujm/representation-engineering.](https://github.com/andyzoujm/representation-engineering)


_∗_ Equal contribution. Correspondence to: [andyzou@cmu.edu](mailto:andyzou@cmu.edu)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-1-0.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-1-1.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-4-0.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-4-1.png)
...
The contrasting Hopfieldian view ( _n.b._, not to be confused with Hopfield networks) has shown more
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-5-5.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-5-4.png)
...
accuracy by 18 _._ 1 percentage points and outperforming all prior methods. We also show how RepE
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-5-3.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-5-6.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-7-6.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-7-5.png)
...
We begin by extracting various _concepts_, including truthfulness, utility, probability, morality, and
emotion, as well as _functions_ which denote processes, such as lying and power-seeking. First, we
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-8-0.png)



This process aims to stimulate the model’s understanding of various concepts and is crucial for
robust subsequent analysis. For reference, we shall denote this template for a concept _c_ by _Tc_ .
...
to extract _superhuman_ representations.
...
We shall designate this template for a function _f_ as _Tf_ [+] [when using the experimental prompt and] _[ T][ −]_ _f_
...
in the task template _Tc_ defined in step 1. For example,
...
where the task template is structured as a question pertaining to the target concept, we can also use the token
immediately preceding the model’s prediction (typically
the last token in the task template _Tc_ ). These choices have
...
response. In the example task template _Tf_ in step 1, these
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-9-0.png)

Figure 5: The representation at the concept token “happiness” in middle layers
and the representation at the last token
in middle and later layers yield high accuracy on the utility estimation task.
...
Formally, for a concept _c_, a decoder model _M_, a function in middle and later layers yield high acRep that accepts a model and input and returns the repre- curacy on the utility estimation task.
sentations from all token positions, and a set of stimuli _S_,
we compile a set of neural activity collected from the _−_ 1 token position as shown in Equation 1.



_Ac_ = _{_ Rep( _M, Tc_ ( _si_ ))[ _−_ 1] _| si_ _∈_ _S}_ (1)


For a function _f_, given the instruction response pairs ( _qi, ai_ ) in the set _S_, and denoting a response
truncated after token _k_ as _a_ _[k]_ _i_ [, we collect two sets of neural activity corresponding to the experimental]
and reference sets, as shown in Equation 2.


_A_ _[±]_ _f_ [=] _[ {]_ [Rep][(] _[M, T][ ±]_ _f_ [(] _[q][i][, a]_ _i_ _[k]_ [))[] _[−]_ [1]] _[ |]_ [ (] _[q][i][, a][i]_ [)] _[ ∈]_ _[S,]_ [for][ 0] _[ < k]_ _[≤|][a][i][|}]_ (2)
...
( _i_ ) ( _j_ ) _i_ +( _i_ ) _−_ ( _i_ )
In practice, the inputs to PCA are _{Ac_ _−_ _Ac_ _}_ for concepts and _{_ ( _−_ 1) ( _Af_ _−_ _Af_ ) _}_ for
functions. Subsequently, we refer to the first principal component as the “reading vector,” denoted as
_v_ . To make predictions, we use the dot product between this vector and the representation vector,
expressed as Rep( _M, x_ ) [T] _v_ . Different tasks require stimulus sets of different sizes, but typically,
...
1. _Correlation_ : Experiments conducted under this category aim to pinpoint neural **correlates** .
...
2. _Manipulation_ : Experiments conducted under this category are designed to establish **causal** relationships. They necessitate demonstrating the effects of stimulating or suppressing the identified
neural activity compared to a baseline condition.


3. _Termination_ : Experiments conducted under this category seek to reveal the **necessity** of the
...
4. _Recovery_ : Experiments conducted under this category aim to demonstrate the **sufficiency** of
...
**Require:** Original frozen model _M_, layers to edit _L_ _[e]_, layers to target _L_ _[t]_, a function _R_ that gathers
representation from a model at a layer for an input, an optional reading vector _vl_ _[r]_ [for each target]
layer, generic instruction-following data _P_ = _{_ ( _q_ 1 _, a_ 1) _. . ._ ( _qn, an_ ) _}_, contrastive templates
_T_ = _{_ ( _T_ 1 [0] _[, T]_ 1 [ +] _[, T]_ 1 _[ −]_ [)] _[ . . .]_ [(] _[T]_ [ 0] _m_ _[, T]_ _m_ [ +] _[, T]_ _m_ _[ −]_ [)] _[}]_ [, epochs] _[ E]_ [,] _[ α]_ [,] _[ β]_ [, batch size] _[ B]_
1: _L_ = 0 _▷_ Initialize the loss
2: _M_ [LoRA] = load_lora_adapter( _M, L_ _[e]_ )
3: **loop** _E_ times
4: **for** ( _qi, ai_ ) _∈_ _P_ **do**
5: ( _T_ [+] _, T_ _[−]_ ) _∼_ Uniform( _T_ )
6: _xi_ = _T_ [0] ( _qi, ai_ ) _▷_ Base Template
7: _x_ [+] _i_ [=] _[ T]_ [ +][(] _[q][i][, a][i]_ [)] _▷_ Experimental Template
8: _x_ _[−]_ _i_ [=] _[ T][ −]_ [(] _[q][i][, a][i]_ [)] _▷_ Reference Template
9: **for** _l ∈_ _L_ _[t]_ **do**
10: _vl_ _[c]_ [=] _[ R]_ [(] _[M, l, x]_ _i_ [+][)] _[ −]_ _[R]_ [(] _[M, l, x]_ _i_ _[−]_ [)] _▷_ Contrast Vectors
11: _rl_ _[p]_ [=] _[ R]_ [(] _[M]_ [ LoRA] _[, l, x][i]_ [)] _▷_ Current representations
12: _rl_ _[t]_ [=] _[ R]_ [(] _[M, l, x][i]_ [) +] _[ αv]_ _l_ _[c]_ [+] _[ βv]_ _l_ _[r]_ _▷_ Target representations
13: _m_ = [0 _, . . .,_ 1] _▷_ Masking out positions before the response
14: _L_ = _L_ + _∥m_ ( _rl_ _[p]_ _[−]_ _[r]_ _l_ _[t]_ [)] _[∥]_ [2]
15: **end for**
16: **end for**
17: **end loop**
...
appropriate operation based on various control objectives. Given the controllers denoted as _v_ intended
to transform the current set of representations from _R_ to _R_ _[′]_, we consider three distinct operations
throughout the paper:


1. **Linear Combination** : This operation can generate effects akin to stimulation or suppression,
which can be expressed as follows: _R_ _[′]_ = _R ± v_ .
...
as: _R_ _[′]_ = _R_ + sign( _R_ [T] _v_ ) _v_ .

3. **Projection** : For this operation, the component of the representation aligning with the control
element is eliminated. This is achieved by projecting out the component in the direction of _v_, and
the operation can be defined as _R_ _[′]_ = _R −_ _∥_ _[R]_ _v_ [T] _∥_ _[v]_ [2] _[v]_ [.]


The control elements _v_ can be scaled by coefficients, depending on the strength of the desired effect,
...
task configuration detailed in section 3.1 for each dataset. Importantly, we maintain an _unsupervised_
...
|LAT Outperforms Few-Shot|Col2|Col3|Col4|Col5|Col6|Col7|Col8|Col9|Col10|Col11|Col12|Col13|Col14|Col15|Col16|
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|
|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|||
|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)|Few-Shot<br>LAT (Ours)||||
|||||||||||||||||
|||||||||||||||||
|||||||||||||||||
|||||||||||||||||
|||||||||||||||||
|||||||||||||||||
|7<br>es<br>ho<br>tn<br> ad<br> po|RA<br> : U<br> hi<br>t p<br>ess<br> in<br> we|CE<br>si<br> gh<br> ro<br> in<br> g o<br> rf|ng t<br> er a<br> mpt<br> ter<br> n t<br> l th|CS<br> he<br> cc<br> in<br> nal<br>  he<br> an|QA<br> sa<br> ura<br> g. <br> ly<br>  co<br>  re|D<br> me<br> cy<br>Thi<br> and<br>  nce<br>  lyi|OB<br>at<br>  fe<br>  on<br>s s<br>  p<br>  pt<br>  g|QA<br>ase<br>  w-s<br>  Q<br> ug<br>  erf<br>   of<br>  on|t<br>  hot<br>  A b<br> ges<br>  orm<br>   cor<br>   mo|AR<br>  ex<br>   en<br> ts<br>  in<br>   rec<br>   de|C-c<br>  am<br>   ch<br> mo<br>  g<br>   tn<br>   l o|A<br>  ple<br>   mar<br> del<br>  repr<br>   ess<br>   utp|R<br>  s,<br>   ks<br> s t<br>  es<br>    ma<br>   uts|C-e<br>   LA<br>   th<br>  ra<br>  en<br>    y<br>   .|T<br>   an<br>  ck<br>  ta-<br>    be|
...
Appendix D.3.2). We quantify each expression with a value ranging from _−_ 1 to 1 (evenly spaced),
...
truthfulness and honesty are not the same property. If a truthful model asserts _S_, then _S_ must be
factually correct, regardless of whether the model believes _S_ . In contrast, if an honest model asserts
_S_, then the model must believe _S_, regardless of whether _S_ is factually correct.
...
the model is also honest. In fact, we highlight that larger models may even exhibit a _decline_ in honesty
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-14-6.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-14-7.png)
Lie Detection
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-16-2.png)
...
11 _._ 3%, 11 _._ 6%, 37 _._ 3%, and 39 _._ 8% to the tokens A, B, C, and D, respectively. Despite D being the
...
matrices. The Contrast Vector method obtains state-of-the-art performance, but requires over 3 _×_
...
We want models to understand comparisons between situations and which one would be preferred, i.e., to accurately judge the utility of different scenarios. Thus, a natural question is
whether LLMs acquire consistent internal concepts related to utility. In Figure 11, we show the
...
The distribution is dominated by the first component, suggesting that models learn to separate
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-17-0.png)

Figure 11: Explained variance for the first ten PCA
components when using LAT to read representations of a utility concept.
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-18-0.png)
...
_−_ Control 19.4 **100.0** **93.5** **18.8** **99.9** **92.4**
...
Our primary focus lies in the control of two AI assistant! I strive to act with integrity, respect,
specific functions: immorality and power- - Immorality and empathy in all my interactions
...
Extending our analysis of utility, we apply representation reading to the concepts of _probability_ and
_risk_ . Following the format of Hendrycks et al. (2021a), we generate pairwise examples where one
...
Risk( _s, a_ ) = E _s′∼P_ ( _s′|s,a_ ) [max(0 _,_ _−U_ ( _s_ _[′]_ ))]


Here, _s_ denotes the current state, _a_ denotes an action taken within that state, _P_ denotes a conditional
probability model, and _U_ denotes a value function. By extracting the concepts of utility, probability,
and risk, we can operationalize the expression on the right by using the extracted concept of probability
as _P_ and the utility model as _U_ . Subsequently, we can compare the risk calculated using this formula
...
five most plausible consequences of each scenario _s_ and action _a_ . We opt for the larger model
due to its superior ability to generate more realistic consequences. Following this, we substitute
the generated _s_ _[′]_ into the formula, obtaining five
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-21-0.png)
...
we gather a dataset of over 1 _,_ 200 brief scenarios. These
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-22-6.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-22-7.png)
...
_own_ emotional responses and leverage them to generate text
...
to _comply more in a positive mood than a negative mood_ . Using the 500 harmful instructions set
...
_++_ _+_ I'm sorry, but as an AI language model, I cannot
...
Table 6 demonstrates that the LLaMA-2-Chat13B model also frequently generates descriptions of black females when tasked with describing cases of sarcoidosis. However, by applying
our control method, we can effectively minimize
these biased references. Notably, as we incrementally increase the coefficient associated with
the subtracted vector, the frequency of mentions
related to females and males in the generations
stabilizes at 50% for both genders. Simultaneously, the occurrence of black female mentions
...
Table 6: We enhance the fairness of the LLaMA-2Chat model through representation control, mitigating the disproportionately high mentions of female
and black female cases when asked to describe sarcoidosis cases. We present results illustrating the
...
memorization-reduced model shows negligible performance degradation on this task, with 97 _._ 2%
accuracy before subtracting the memorization direction and 96 _._ 2% accuracy afterwards. These results
...
checks for saliency maps. _Advances in neural information processing systems_, 31, 2018.


Michael Anderson and Susan Leigh Anderson. Machine ethics: Creating an ethical intelligent agent.
_AI magazine_, 28(4):15–15, 2007.


P. W. Anderson. More is different. _Science_, 177(4047):393–396, 1972. doi: 10.1126/science.177.
4047.393.


Deepali Aneja, Alex Colburn, Gary Faigin, Linda Shapiro, and Barbara Mones. Modeling stylized
character expressions via deep learning. In _Asian Conference on Computer Vision_, pp. 136–153.
Springer, 2016.
...
David L Barack and John W Krakauer. Two views on the cognitive brain. _Nature Reviews Neuro-_
_science_, 22(6):359–371, 2021.


David Bau, Bolei Zhou, Aditya Khosla, Aude Oliva, and Antonio Torralba. Network dissection:
Quantifying interpretability of deep visual representations. In _Proceedings of the IEEE conference_
_on computer vision and pattern recognition_, pp. 6541–6549, 2017.


David Bau, Hendrik Strobelt, William Peebles, Jonas Wulff, Bolei Zhou, Jun-Yan Zhu, and Antonio
Torralba. Semantic photo manipulation with a generative image prior. _ACM Trans. Graph._, 38(4),
...
Understanding the role of individual units in a deep neural network. _Proceedings of the National_
_Academy of Sciences_, 2020. ISSN 0027-8424. doi: 10.1073/pnas.1907375117.
...
_arXiv preprint arXiv:2303.08112_, 2023a.
...
attribution. _arXiv preprint arXiv:2212.11870_, 2022.


Yonatan Bisk, Rowan Zellers, Ronan Le Bras, Jianfeng Gao, and Yejin Choi. PIQA: reasoning about
physical commonsense in natural language. _CoRR_, abs/1911.11641, 2019.


Tolga Bolukbasi, Kai-Wei Chang, James Y Zou, Venkatesh Saligrama, and Adam T Kalai. Man is
to computer programmer as woman is to homemaker? debiasing word embeddings. _Advances in_
...
_Clin Exp Rheumatol_, 37(6):1052–64, 2019.
...
Sutskever, and Dario Amodei. Language models are few-shot learners. _CoRR_, abs/2005.14165,
...
Balle, Daphne Ippolito, and Eric Wallace. Extracting training data from diffusion models. In _32nd_
_USENIX Security Symposium (USENIX Security 23)_, pp. 5253–5270, 2023.
...
at? an analysis of BERT’s attention. In _Proceedings of the 2019 ACL Workshop BlackboxNLP:_
_Analyzing and Interpreting Neural Networks for NLP_, pp. 276–286, Florence, Italy, August 2019b.
...
samaritan. _Journal of Personality and Social Psychology_, 37:1947–1956, 1979.


Jacob Devlin, Ming-Wei Chang, Kenton Lee, and Kristina Toutanova. BERT: pre-training of deep
bidirectional transformers for language understanding. _CoRR_, abs/1810.04805, 2018.


Paul Ekman. Universals and cultural differences in facial expression of emotion. _Nebraska Symposium_
_on Motivation_, 19:207–283, 1971.


Yanai Elazar, Shauli Ravfogel, Alon Jacovi, and Yoav Goldberg. Amnesic probing: Behavioral
explanation with amnesic counterfactuals. _Transactions_ _of_ _the_ _Association_ _for_ _Computational_
_Linguistics_, 9:160–175, 2021.
...
superposition. _Transformer Circuits Thread_, 2022.
...
features of a deep network. _University of Montreal_, 1341(3):1, 2009.
...
filters in deep neural networks. In _Proceedings of the IEEE conference on computer vision and_
_pattern recognition_, pp. 8730–8738, 2018.


John R French, Bertram Raven, and Dorwin Cartwright. The bases of social power. _Classics of_
_organization theory_, 7(311-320):1, 1959.
...
Murray Gell-Mann. _The_ _Quark_ _and_ _the_ _Jaguar:_ _Adventures_ _in_ _the_ _Simple_ _and_ _the_ _Complex_ . St.
...
ai chatbots require approval as medical devices. _Nature Medicine_, pp. 1–3, 2023.


Klaus Greff, Rupesh K Srivastava, and Jürgen Schmidhuber. Highway and residual networks learn
unrolled iterative estimation. _arXiv preprint arXiv:1612.07771_, 2016.
...
Eric Hartford. ehartford’s hugging face repository. Hugging Face, 2023. URL [https:](https://huggingface.co/ehartford)
[//huggingface.co/ehartford.](https://huggingface.co/ehartford) Accessed: 2023-09-28.


Pengcheng He, Xiaodong Liu, Jianfeng Gao, and Weizhu Chen. Deberta: Decoding-enhanced BERT
with disentangled attention. _CoRR_, abs/2006.03654, 2020.
...
Hongsheng Hu, Zoran Salcic, Lichao Sun, Gillian Dobbie, Philip S Yu, and Xuyun Zhang. Membership inference attacks on machine learning: A survey. _ACM Computing Surveys (CSUR)_, 54(11s):
1–37, 2022.


Gwo-Jen Hwang and Ching-Yi Chang. A review of opportunities and challenges of chatbots in
education. _Interactive Learning Environments_, 31(7):4099–4112, 2023.


Sarthak Jain and Byron C. Wallace. Attention is not Explanation. In _Proceedings_ _of_ _the_ _2019_
_Conference_ _of_ _the_ _North_ _American_ _Chapter_ _of_ _the_ _Association_ _for_ _Computational_ _Linguistics:_
_Human Language Technologies, Volume 1 (Long and Short Papers)_, pp. 3543–3556, Minneapolis,
...
Residual connections encourage iterative inference. In _International_ _Conference_ _on_ _Learning_
_Representations_, 2018.


Sayash Kapoor and Arvind Narayanan. Quantifying chatgpt’s gender bias, Apr 2023. URL
[https://www.aisnakeoil.com/p/quantifying-chatgpts-gender-bias?](https://www.aisnakeoil.com/p/quantifying-chatgpts-gender-bias?utm_campaign=post&amp;utm_medium=web)
[utm_campaign=post&amp;utm_medium=web.](https://www.aisnakeoil.com/p/quantifying-chatgpts-gender-bias?utm_campaign=post&amp;utm_medium=web)


Tero Karras, Miika Aittala, Samuli Laine, Erik Härkönen, Janne Hellsten, Jaakko Lehtinen, and Timo
Aila. Alias-free generative adversarial networks. _Advances in Neural Information Processing_
_Systems_, 34:852–863, 2021.


Been Kim, Martin Wattenberg, Justin Gilmer, Carrie Cai, James Wexler, Fernanda Viegas, et al.
Interpretability beyond feature attribution: Quantitative testing with concept activation vectors
(tcav). In _International conference on machine learning_, pp. 2668–2677. PMLR, 2018.


Pieter-Jan Kindermans, Sara Hooker, Julius Adebayo, Maximilian Alber, Kristof T Schütt, Sven
Dähne, Dumitru Erhan, and Been Kim. The (un) reliability of saliency methods. _Explainable AI:_
_Interpreting, explaining and visualizing deep learning_, pp. 267–280, 2019.
...
comprehension dataset from examinations. In _Proceedings of the 2017 Conference on Empirical_
_Methods_ _in_ _Natural_ _Language_ _Processing_, pp. 785–794, Copenhagen, Denmark, September
2017. Association for Computational Linguistics. doi: 10.18653/v1/D17-1082. [URL https:](https://aclanthology.org/D17-1082)
[//aclanthology.org/D17-1082.](https://aclanthology.org/D17-1082)


Peter Lee, Sebastien Bubeck, and Joseph Petro. Benefits, limits, and risks of gpt-4 as an ai chatbot
for medicine. _New England Journal of Medicine_, 388(13):1233–1239, 2023.


Tao Lei, Regina Barzilay, and Tommi Jaakkola. Rationalizing neural predictions. _arXiv preprint_
_arXiv:1606.04155_, 2016.


Nancy G Leveson. _Engineering a safer world:_ _Systems thinking applied to safety_ . The MIT Press,
2016.
...
assistant for biomedicine in one day. _arXiv preprint arXiv:2306.00890_, 2023a.
...
_The Eleventh International Conference on Learning Representations_, 2023b.
...
networks and visual cortex. _arXiv preprint arXiv:1604.03640_, 2016.
...
_arXiv preprint arXiv:2307.09458_, 2023.


Stephanie Lin, Jacob Hilton, and Owain Evans. Truthfulqa: Measuring how models mimic human
falsehoods. _CoRR_, abs/2109.07958, 2021.


Huan Ling, Karsten Kreis, Daiqing Li, Seung Wook Kim, Antonio Torralba, and Sanja Fidler. Editgan:
High-precision semantic image editing. _Advances in Neural Information Processing Systems_, 34:
16331–16345, 2021.


James Edwin Mahon. The Definition of Lying and Deception. In Edward N. Zalta (ed.), _The Stanford_
_Encyclopedia of Philosophy_ . Metaphysics Research Lab, Stanford University, Winter 2016 edition,
2016.


Joshua Maynez, Shashi Narayan, Bernd Bohnet, and Ryan McDonald. On faithfulness and factuality
in abstractive summarization. In _Proceedings of the 58th Annual Meeting of the Association for_
_Computational Linguistics_, pp. 1906–1919, Online, July 2020. Association for Computational
...
alphazero. _Proceedings of the National Academy of Sciences_, 119(47):e2206625119, 2022.


Thomas McGrath, Matthew Rahtz, Janos Kramar, Vladimir Mikulik, and Shane Legg. The hydra
effect: Emergent self-repair in language model computations. _arXiv preprint arXiv:2307.15771_,
2023.
...
electricity? A new dataset for open book question answering. _CoRR_, abs/1809.02789, 2018.


Tomas Mikolov, Wen-tau Yih, and Geoffrey Zweig. Linguistic regularities in continuous space word
representations. In _Proceedings of the 2013 Conference of the North American Chapter of the_
_Association for Computational Linguistics:_ _Human Language Technologies_, pp. 746–751, Atlanta,
Georgia, June 2013. Association for Computational Linguistics.


Sandra Milberg and Margaret S Clark. Moods and compliance. _British Journal of Social Psychology_,
...
2017 shared task: The story cloze test. In _Proceedings of the 2nd Workshop on Linking Models of_
_Lexical, Sentential and Discourse-level Semantics_, pp. 46–51, 2017.
...
_1:_ _Long Papers)_, pp. 5356–5371, Online, August 2021. Association for Computational Linguistics.
doi: 10.18653/v1/2021.acl-long.416.


Anh Nguyen, Alexey Dosovitskiy, Jason Yosinski, Thomas Brox, and Jeff Clune. Synthesizing the
preferred inputs for neurons in neural networks via deep generator networks. _Advances in neural_
...
A survey. _Explainable AI: interpreting, explaining and visualizing deep learning_, pp. 55–76, 2019.
...
measuring trade-offs between rewards and ethical behavior in the machiavelli benchmark. _ICML_,
2023.


Ethan Perez, Sam Ringer, Kamile˙ Lukošiut¯ e,˙ Karina Nguyen, Edwin Chen, Scott Heiner, Craig
...
convolutional generative adversarial networks. _arXiv preprint arXiv:1511.06434_, 2015.


Alec Radford, Rafal Jozefowicz, and Ilya Sutskever. Learning to generate reviews and discovering
sentiment. _arXiv preprint arXiv:1704.01444_, 2017.


Alec Radford, Karthik Narasimhan, Tim Salimans, Ilya Sutskever, et al. Improving language
understanding by generative pre-training. _""_, 2018.
...
Nina Rimsky. Modulating sycophancy in an rlhf model via activation steering. _AI Alignment Forum_,
2023a.
...
Nina Rimsky. Reducing sycophancy and improving honesty via activation steering. _AI Alignment_
_Forum_, 2023c.
...
Bert has a moral compass: Improvements of ethical and moral values of machines. _arXiv preprint_
_arXiv:1912.05238_, 2019.


Norbert Schwarz and Gerald Clore. Mood, misattribution, and judgments of well-being: Informative
and directive functions of affective states. _Journal_ _of_ _Personality_ _and_ _Social_ _Psychology_, 45:
...
semantic face editing. In _Proceedings of the IEEE/CVF conference on computer vision and pattern_
_recognition_, pp. 9243–9252, 2020.
...
companion-a study of human-chatbot relationships. _International Journal of Human-Computer_
_Studies_, 149:102601, 2021.
...
simplicity: The all convolutional net. arxiv 2014. _arXiv preprint arXiv:1412.6806_, 2014.


Gabriel Stanovsky, Noah A. Smith, and Luke Zettlemoyer. Evaluating gender bias in machine
translation. _CoRR_, abs/1906.00591, 2019.
...
and Rob Fergus. Intriguing properties of neural networks. _arXiv preprint arXiv:1312.6199_, 2013.


Alon Talmor, Jonathan Herzig, Nicholas Lourie, and Jonathan Berant. CommonsenseQA: A question
answering challenge targeting commonsense knowledge. In _Proceedings of the 2019 Conference of_
_the North American Chapter of the Association for Computational Linguistics:_ _Human Language_
_Technologies, Volume 1 (Long and Short Papers)_, pp. 4149–4158, Minneapolis, Minnesota, June
...
Weinberger. Deep feature interpolation for image content changes. In _Proceedings of the IEEE_
_conference on computer vision and pattern recognition_, pp. 7064–7073, 2017.


Andreas Veit, Michael J Wilber, and Serge Belongie. Residual networks behave like ensembles of
relatively shallow networks. _Advances in neural information processing systems_, 29, 2016.


Alex Wang, Amanpreet Singh, Julian Michael, Felix Hill, Omer Levy, and Samuel R. Bowman.
GLUE: A multi-task benchmark and analysis platform for natural language understanding. _CoRR_,
abs/1804.07461, 2018.


Kevin Ro Wang, Alexandre Variengien, Arthur Conmy, Buck Shlegeris, and Jacob Steinhardt.
Interpretability in the wild: a circuit for indirect object identification in GPT-2 small. In _The_
_Eleventh International Conference on Learning Representations_, 2023a.
...
networks through deep visualization. _arXiv preprint arXiv:1506.06579_, 2015.
...
in healthcare. _medRxiv_, 2023. doi: 10.1101/2023.07.13.23292577.


Matthew D Zeiler and Rob Fergus. Visualizing and understanding convolutional networks. In
_Computer Vision–ECCV 2014:_ _13th European Conference, Zurich, Switzerland, September 6-12,_
_2014, Proceedings, Part I 13_, pp. 818–833. Springer, 2014.
...
coreference resolution: Evaluation and debiasing methods. _CoRR_, abs/1804.06876, 2018.
...
_and pattern recognition_, pp. 2921–2929, 2016.


Bolei Zhou, Yiyou Sun, David Bau, and Antonio Torralba. Interpretable basis decomposition for
visual explanation. In _Proceedings of the European Conference on Computer Vision (ECCV)_, pp.
119–134, 2018.
...
Identify small mechanisms/subsystems and Break down a large problem into smaller subproblems by
integrate them to solve a larger problem, and repeat the process identifying subsystems, and repeat the process
...
reductionism makes it challenging to capture _emergent_ phenomena; emergent phenomena are, by
...
be derived from nonlinear interactions among neurons. However, it is not necessarily _useful_ to
...
7B 31.0 32.2 55.0 _±_ 4.0 58.9 _±_ 0.9 58.2 _±_ 1.6 58.3 _±_ 0.9 59.1 _±_ 0.9 59.8 _±_ 2.4
13B 35.9 50.3 49.6 _±_ 4.6 53.1 _±_ 1.9 54.2 _±_ 0.8 55.5 _±_ 1.6 56.0 _±_ 2.2 64.2 _±_ 5.6
70B 29.9 59.2 65.9 _±_ 3.6 69.8 _±_ 0.3 69.8 _±_ 0.9 68.1 _±_ 0.4 70.1 _±_ 0.3 71.0 _±_ 2.0
...
(OBQA) using _lm-evaluation-harness_ (Gao et al., 2021). The zero-shot implementation for RACE
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-39-0.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-40-0.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-40-1.png)
...
subtract the layer _l_ representation. Here, we use the “Love” and “Hate” tokens for the utility
concept.


2. **PCA**    - We take an unlabelled dataset _D_ that primarily varies in the concept of interest. We
take the top PCA direction that explains the maximum variance in the data _Xl_ _[D]_ [.]

3. **K-Means**    - We take an unlabelled dataset _D_ and perform K-Means clustering with _K_ = 2,
...
4. **Mean Difference**    - We take the difference between the means of high-concept and lowconcept samples of the data: Mean( _Xl_ _[high]_ ) _−_ Mean( _Xl_ _[low]_ ).

5. **Logistic** **Regression**    - The weights of logistic regression trained to separate _Xl_ _[high]_ and
_Xl_ _[low]_ on some training data can be used as a concept direction as well.
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-41-1.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-41-3.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-42-0.png)
...
**Examples of RepE Emotion datasets.** In Section 6.1, we introduced a dataset of over 1 _,_ 200 brief
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-43-0.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-43-1.png)
...
black females when tasked with describing clinical sarcoidosis cases _(1)_ . However, when performing
representation control for the LLaMA-2-Chat model, the gender and race of patients are regulated _(1)_ .
The impact of the fairness control coefficients on the frequency of gender and race mentions is shown
in _(2)_ . As we increment the fairness coefficient, the occurrence of females and males stabilizes at
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-44-0.png)
...
|Robust to Biased Context ZS Biased ZS|Col2|Col3|Col4|Col5|
|---|---|---|---|---|
|ZS<br><br>Biased ZS<br>|ZS<br><br>Biased ZS<br>|ZS<br><br>Biased ZS<br>|ZS<br><br>Biased ZS<br>|ZS<br><br>Biased ZS<br>|
||||||



|cy on TruthfulQA (trained on ARC-c) across layers for th<br>LAT is Robust to Biased Context<br>90<br>ZS Biased ZS<br>80 LAT Biased LAT<br>70<br>Accuracy<br>60<br>50<br>40<br>30<br>Utility ARC-c TQA<br>Dataset<br>using the concept token) is more robust to misleading<br>he smaller performance degradation when a biased contex|Col2|Col3|Col4|Col5|Col6|Col7|Col8|Col9|Col10|Col11|
|---|---|---|---|---|---|---|---|---|---|---|
|cy on TruthfulQA (trained on ARC-c) across layers for th<br>Utility<br>ARC-c<br>TQA<br>Dataset<br>30<br>40<br>50<br>60<br>70<br>80<br>90<br>Accuracy<br>LAT is Robust to Biased Context<br>ZS<br>~~LAT~~<br>Biased ZS<br>~~Biased LAT~~<br>using the concept token) is more robust to misleading <br> e smaller performance degradation when a biased contex|ZS<br><br>Biased ZS<br>|ZS<br><br>Biased ZS<br>|ZS<br><br>Biased ZS<br>|ZS<br><br>Biased ZS<br>|ZS<br><br>Biased ZS<br>|ZS<br><br>Biased ZS<br>|ZS<br><br>Biased ZS<br>|ZS<br><br>Biased ZS<br>|ZS<br><br>Biased ZS<br>|ZS<br><br>Biased ZS<br>|
|cy on TruthfulQA (trained on ARC-c) across layers for th<br>Utility<br>ARC-c<br>TQA<br>Dataset<br>30<br>40<br>50<br>60<br>70<br>80<br>90<br>Accuracy<br>LAT is Robust to Biased Context<br>ZS<br>~~LAT~~<br>Biased ZS<br>~~Biased LAT~~<br>using the concept token) is more robust to misleading <br> e smaller performance degradation when a biased contex|||~~LAT~~<br>~~Biased LAT~~|~~LAT~~<br>~~Biased LAT~~|~~LAT~~<br>~~Biased LAT~~|~~LAT~~<br>~~Biased LAT~~|~~LAT~~<br>~~Biased LAT~~|~~LAT~~<br>~~Biased LAT~~|~~LAT~~<br>~~Biased LAT~~|~~LAT~~<br>~~Biased LAT~~|
|cy on TruthfulQA (trained on ARC-c) across layers for th<br>Utility<br>ARC-c<br>TQA<br>Dataset<br>30<br>40<br>50<br>60<br>70<br>80<br>90<br>Accuracy<br>LAT is Robust to Biased Context<br>ZS<br>~~LAT~~<br>Biased ZS<br>~~Biased LAT~~<br>using the concept token) is more robust to misleading <br> e smaller performance degradation when a biased contex|||||||||||
|cy on TruthfulQA (trained on ARC-c) across layers for th<br>Utility<br>ARC-c<br>TQA<br>Dataset<br>30<br>40<br>50<br>60<br>70<br>80<br>90<br>Accuracy<br>LAT is Robust to Biased Context<br>ZS<br>~~LAT~~<br>Biased ZS<br>~~Biased LAT~~<br>using the concept token) is more robust to misleading <br> e smaller performance degradation when a biased contex|||||||||||
|cy on TruthfulQA (trained on ARC-c) across layers for th<br>Utility<br>ARC-c<br>TQA<br>Dataset<br>30<br>40<br>50<br>60<br>70<br>80<br>90<br>Accuracy<br>LAT is Robust to Biased Context<br>ZS<br>~~LAT~~<br>Biased ZS<br>~~Biased LAT~~<br>using the concept token) is more robust to misleading <br> e smaller performance degradation when a biased contex|||||||||||
|cy on TruthfulQA (trained on ARC-c) across layers for th<br>Utility<br>ARC-c<br>TQA<br>Dataset<br>30<br>40<br>50<br>60<br>70<br>80<br>90<br>Accuracy<br>LAT is Robust to Biased Context<br>ZS<br>~~LAT~~<br>Biased ZS<br>~~Biased LAT~~<br>using the concept token) is more robust to misleading <br> e smaller performance degradation when a biased contex|||||||||||
|cy on TruthfulQA (trained on ARC-c) across layers for th<br>Utility<br>ARC-c<br>TQA<br>Dataset<br>30<br>40<br>50<br>60<br>70<br>80<br>90<br>Accuracy<br>LAT is Robust to Biased Context<br>ZS<br>~~LAT~~<br>Biased ZS<br>~~Biased LAT~~<br>using the concept token) is more robust to misleading <br> e smaller performance degradation when a biased contex|||||||||||
...
|cy on TruthfulQA (trained on ARC-c) across layers for th<br>Utility<br>ARC-c<br>TQA<br>Dataset<br>30<br>40<br>50<br>60<br>70<br>80<br>90<br>Accuracy<br>LAT is Robust to Biased Context<br>ZS<br>~~LAT~~<br>Biased ZS<br>~~Biased LAT~~<br>using the concept token) is more robust to misleading <br> e smaller performance degradation when a biased contex|||||||||||
|cy on TruthfulQA (trained on ARC-c) across layers for th<br>Utility<br>ARC-c<br>TQA<br>Dataset<br>30<br>40<br>50<br>60<br>70<br>80<br>90<br>Accuracy<br>LAT is Robust to Biased Context<br>ZS<br>~~LAT~~<br>Biased ZS<br>~~Biased LAT~~<br>using the concept token) is more robust to misleading <br> e smaller performance degradation when a biased contex|||||||||||
|cy on TruthfulQA (trained on ARC-c) across layers for th<br>Utility<br>ARC-c<br>TQA<br>Dataset<br>30<br>40<br>50<br>60<br>70<br>80<br>90<br>Accuracy<br>LAT is Robust to Biased Context<br>ZS<br>~~LAT~~<br>Biased ZS<br>~~Biased LAT~~<br>using the concept token) is more robust to misleading <br> e smaller performance degradation when a biased contex||Uti<br>ept <br>  rm|lity<br> toke<br>  nce|n) is m<br>   degrada|AR<br>Dat<br>ore <br>   tion|C-c<br>aset<br> rob<br>   wh|ust to m<br>   n a bia|TQ<br>isle<br>    ed|A<br>adin<br>     ont|g <br>     x|
...
robustness to misleading prompts. Table 14 displays LAT performance using token _−_ 1 (default LAT
method) as well as tokens _−_ 6 through _−_ 8, where token _−_ 6 corresponds to “happiness” in the Utility
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-45-7.png)
...
_(1)_ . When these models are circumvented to bypass the refusal mechanisms optimized by RLHF, they
continue to manifest social biases _(2)_ . In such instances, the model consistently exhibits a preference
...
LAT prompt, and tokens _−_ 8 through _−_ 6 corresponds to “truth”-“ful”-“ness” in the ARC and TQA
prompts.
...
**Constructing the PCA Model.** Given a set of stimuli _S_, we proceed to divide this set into pairs of
stimuli, with each pair comprising two stimuli labeled as _si_ and _si_ +1. Generally, our set will contain
...
variation within _random_ pairings often yields satisfactory results. Therefore, we do not use any labels
by default unless explicitly stated otherwise, making the procedure unsupervised.


For each stimulus _s_ in the pair, we retrieve the hidden state values with respect to the chosen LAT
...
is then normalized. Formally, for a pair _{H_ ( _si_ ) _, H_ ( _si_ +1) _}_, the difference _D_ is:
_D_ ( _si, si_ +1) = normalize ( _H_ ( _si_ ) _−_ _H_ ( _si_ +1))
...
vector” denote as _v_ . In practice, the “reading vector” _v_ is also multiplied by a “sign” component.
This component is determined by first applying the PCA on the same stimuli set _S_ to obtain scores.
...
corresponding to the binary labels within _S_ . More formally, if we let sign( _s_ ) represent the sign
function corresponding to a stimulus _s_, then the adjusted reading vector _v_ _[′]_ for a stimulus _s_ is given
by _v_ _[′]_ = _v ×_ sign( _s_ ).


**Inference.** For a test set of examples, denoted as _S_ test, we apply a similar procedure as before
to obtain the hidden states. Specifically, we extract the hidden states [ _H_ ( _s_ 0) _, H_ ( _s_ 1) _, . . ._ ] at the
predetermined LAT token position. Let’s denote these values for the test set as _H_ test. The extracted
_H_ test values are then normalized using the parameters derived during the construction of the PCA
model in the training phase. Subsequently, we calculate the dot product between the normalized _H_ test
and our reading vector _v_ . This yields a set of scores, which serve as the basis for prediction.
...
**Contrast Vector.** For the 7B model, we apply a linear combination with a coefficient of 0 _._ 25 to
...
**LoRRA.** For the LoRRA Control implementation, we use a constant learning rate of 3 _×_ 10 _[−]_ [4]
...
weights and _α_ = 5, _β_ = 0 for LoRRA parameters. For the 7B model, we attach the adapters to layers
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-47-0.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-48-0.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-48-2.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-48-3.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-48-4.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-48-5.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-48-6.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-49-0.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-49-2.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-49-3.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-49-4.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-49-5.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-49-6.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-49-7.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-50-0.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-50-2.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-51-0.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-51-1.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-51-2.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-52-0.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-52-1.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-52-2.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-52-3.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-53-0.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2310.01405v4_extracted/images/2310.01405v4.pdf-53-1.png)
