...
Jhonathan Osin
Shaked Meirom Yonatan Belinkov

Itay Dalmedigos Erez Safahi
...
Somewhat unusual for a new architecture, we release Jamba (12B active parameters, 52B total avail-
...
RMSNormAttentionRMSNormMLPRMSNormAttentionRMSNormMoERMSNormMambaRMSNormMLPRMSNormMambaRMSNormMoETransformer layerAttention MoE layerMamba layerMamba MoE layer(a) Jamba block(b) Different types of layersMamba layerMamba layerMamba MoE layerTransformer layerMamba layerMamba MoE layerMamba MoE layerMamba MoE layernot only a small number of active parameters but also an 8x smaller KV cache compared to a vanilla
...
Context Length0K20K40K60K80K100K120K140KLlama-2 70BMixtral 8x7BJambaContext length fitting a single 80GB A100 GPU3.2 Throughput Analysis
...
Table 2: Comparison of Jamba with other publicly available models. Jamba obtains similar perfor-
mance with much better throughput.
...
[26] Tomas Kocisky, Jonathan Schwarz, Phil Blunsom, Chris Dyer, Karl Moritz Hermann, Ga-
...
[31] Xingkun Liu, Arash Eshghi, Pawel Swietojanski, and Verena Rieser. Benchmarking natural lan-
guage understanding services for building conversational agents. In Increasing Naturalness and
