...
et al., 2023, _inter_ _alia_ ). However, such components are generally polysemantic (Elhage et al.,
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2403.19647v3_extracted/images/2403.19647v3.pdf-1-0.png)
...
into an approximate reconstruction **x** ˆ as a sparse sum of features **v** _i_ and an _SAE error term_ _**ϵ**_ ( **x** ) _∈_
R _[d]_ . Here _d_ SAE is the _width_ of the SAE, the _features_ **v** _i_ _∈_ R _[d]_ are unit vectors, the _feature activations_
...
where the sum in (4) ranges over _N_ = 10 equally-spaced _α_ _∈{_ 0 _,_ [1]



where the sum in (4) ranges over _N_ = 10 equally-spaced _α_ _∈{_ 0 _,_ _N_ _[, . . .,]_ _N_ _[}]_ [.] [This] [cannot] [be]
...
IEˆ ig over IEˆ atp scales linearly in _N_ and the serial depth of _m_ ’s computation graph.
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2403.19647v3_extracted/images/2403.19647v3.pdf-3-0.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2403.19647v3_extracted/images/2403.19647v3.pdf-3-1.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2403.19647v3_extracted/images/2403.19647v3.pdf-3-2.png)





![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2403.19647v3_extracted/images/2403.19647v3.pdf-3-3.png)
...
**a** in _G_ and input _x_ _∼D_, we compute IE [ˆ] ( _m_ ; **a** ; _x_ ); we then average over _x_ _∼D_ to produce a score
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2403.19647v3_extracted/images/2403.19647v3.pdf-6-0.png)
...
of SAE error nodes, with the shading indicating the sum of IE terms across nodes in the group. [ˆ] As
...
Prakash et al., 2024; Chen et al., 2024, _inter_ _alia_ ). This typically relies on counterfactual interventions (Lewis, 1973), such as activation patching or path patching on coarse-grained components
...
We release code, data and autoencoders at [github.com/saprmarks/feature-circuits.](https://github.com/saprmarks/feature-circuits) Experimental details can be found in appendices A, E, and G. Our experiments are conducted entirely
on open-weights models. The Gemma Scope SAEs are publicly available (Lieberum et al., 2024).
Features for both SAE suites can be browsed on [Neuronpedia](https://neuronpedia.org) (Lin & Bloom, 2023). Our clusters
...
Biderman. LEACE: Perfect linear concept erasure in closed form. In _Thirty-seventh_ _Confer-_
...
Strong Generalization: Eliciting [Strong](https://arxiv.org/abs/2312.09390) Capabilities With Weak Supervision. _Computing_ _Re-_
...
and Fundamental Limitations of [Reinforcement](https://openreview.net/forum?id=bx24KpJ4Eb) Learning from Human Feedback. _Transactions_
...
Tian Qi Chen, Xuechen Li, Roger Grosse, and David Duvenaud. Isolating sources of disentanglement in variational autoencoders, 2018, Isolating Sources of [Disentanglement](https://openreview.net/forum?id=BJdMRoCIf) in Variational
...
nets. In _Proceedings_ _of_ _the_ _30th_ _International_ _Conference_ _on_ _Neural_ _Information_ _Processing_
...
Deep reinforcement learning from human preferences. _Computing_ _Research_ _Repository_,
...
learning. In Marina Meila and Tong Zhang (eds.), _Proceedings_ _of_ _the_ _38th_ _International_ _Con-_
_ference_ _on_ _Machine_ _Learning_, volume 139 of _Proceedings_ _of_ _Machine_ _Learning_ _Research_, pp.
...
A case study of semantic representation bias in a high-stakes setting. In _Proceedings_ _of_ _the_
_Conference_ _on_ _Fairness,_ _Accountability,_ _and_ _Transparency_, FAT* ’19, pp. 120–128, New York,
NY, USA, 2019. Association for Computing Machinery. [ISBN 9781450361255, Bias in Bios:](https://doi.org/10.1145/3287560.3287572) A
...
Toy models of superposition. _Transformer_ _Circuits_ _Thread_, 2022. https://transformercircuits.pub/2022/toy ~~m~~ odel/index.html.
...
Chengqing Zong, Fei Xia, Wenjie Li, and Roberto Navigli (eds.), _Proceedings_ _of_ _the_ _59th_ _An-_
_nual_ _Meeting_ _of_ _the_ _Association_ _for_ _Computational_ _Linguistics_ _and_ _the_ _11th_ _International_ _Joint_
_Conference on Natural Language Processing (Volume 1:_ _Long Papers)_, pp. 1828–1843, Online,
August 2021. Association for Computational Linguistics, Causal Analysis [of](https://aclanthology.org/2021.acl-long.144) Syntactic Agree[ment Mechanisms in Neural Language Models.](https://aclanthology.org/2021.acl-long.144)
...
Jan Leike, and Jeffrey Wu. Scaling and evaluating sparse autoencoders. _Computing_ _Research_
...
_Proceedings_ _of_ _Machine_ _Learning_ _Research_, pp. 7324–7338. PMLR, 17–23 Jul 2022, [Inducing](https://proceedings.mlr.press/v162/geiger22a.html)
...
Interpreting mathematical abilities in a pre-trained language model. In _Thirty-seventh_ _Confer-_
...
circuit overlap when finding model mechanisms. In _ICML_ _2024_ _Workshop_ _on_ _Mechanistic_ _In-_
_terpretability_, 2024, Have Faith in Faithfulness: Going [Beyond](https://openreview.net/forum?id=grXgesr5dT) Circuit Overlap When Finding
...
_ings_ _of_ _the_ _62nd_ _Annual_ _Meeting_ _of_ _the_ _Association_ _for_ _Computational_ _Linguistics_ _(Volume_ _1:_
...
constrained variational framework. In _International_ _Conference_ _on_ _Learning_ _Representations_,
...
volume 177 of _Proceedings_ _of_ _Machine_ _Learning_ _Research_, pp. 336–351. PMLR, 11–13 Apr
...
Naoaki Okazaki (eds.), _Findings_ _of_ _the_ _Association_ _for_ _Computational_ _Linguistics:_ _ACL_ _2023_,
...
for mitigating social bias without demographic information. _Computing_ _Research_ _Repository_,
2403.09516, 2024.
...
_Conference_ _on_ _Machine_ _Learning_, volume 139 of _Proceedings_ _of_ _Machine_ _Learning_ _Research_,
...
scaling. In _Thirty-seventh_ _Conference_ _on_ _Neural_ _Information_ _Processing_ _Systems_, 2023, [The](https://openreview.net/forum?id=3tbTw2ga8K)
...
Yonatan Belinkov. The quest for the right mediator: A history, survey, and theoretical grounding of causal interpretability, 2024, The Quest for the Right [Mediator:](https://arxiv.org/abs/2408.01416) A History, Survey, and
...
Tuomas Oikarinen, Subhro Das, Lam M. Nguyen, and Tsui-Wei Weng. Label-free concept bottleneck models. In _The_ _Eleventh_ _International_ _Conference_ _on_ _Learning_ _Representations_, 2023,
...
_Association_ _for_ _Computational_ _Linguistics_ _(Volume_ _1:_ _Long_ _Papers)_, pp. 8801–8821, Toronto,
...
Judea Pearl. Direct and indirect effects. In _Proceedings of_ _the Seventeenth Conference_ _on Uncer-_
_tainty_ _in_ _Artificial_ _Intelligence_, UAI’01, pp. 411–420, San Francisco, CA, USA, 2001. Morgan
...
enhances existing mechanisms: A case study on entity tracking. In _Proceedings_ _of_ _the_ _2024_
...
autoencoders, Jumping Ahead: Improving [Reconstruction](https://arxiv.org/abs/2407.14435) Fidelity with JumpReLU Sparse Au[toencoders.](https://arxiv.org/abs/2407.14435) _Computing Research Repository_, arXiv:2407.14435, 2024b.
...
Schluter, and Joel Tetreault (eds.), _Proceedings_ _of_ _the_ _58th_ _Annual_ _Meeting_ _of_ _the_ _Association_
...
Sivan Sabato (eds.), _Proceedings_ _of_ _the_ _39th_ _International_ _Conference_ _on_ _Machine_ _Learning_,
...
in kernel space. In Yoav Goldberg, Zornitsa Kozareva, and Yue Zhang (eds.), _Proceedings_ _of_
_the_ _2022_ _Conference_ _on_ _Empirical_ _Methods_ _in_ _Natural_ _Language_ _Processing_, pp. 6034–6055,
...
effects, Identifiability and [Exchangeability](http://www.jstor.org/stable/3702894) for Direct and Indirect Effects. _Epidemiology_, 3(2):
...
_Data_ _Analysis,_ _IDA_ _2021,_ _Porto,_ _Portugal,_ _April_ _26–28,_ _2021,_ _Proceedings_, pp. 63–75, Berlin,
Heidelberg, 2021. Springer-Verlag. ISBN 978-3-030-74250-8, Explaining [Neural](https://doi.org/10.1007/978-3-030-74251-5_6) Networks by
...
_2022:_ _Workshop_ _on_ _Spurious_ _Correlations,_ _Invariance_ _and_ _Stability_, 2022, [BARACK:](https://openreview.net/forum?id=Rn9POk3wOiV) Partially
...
Joshua Batson, Adam Jermyn, Shan Carter, Chris Olah, and Tom Henighan. Scaling monosemanticity: [Extracting interpretable features from claude 3 sonnet, Scaling Monosemanticity:](https://transformer-circuits.pub/2024/scaling-monosemanticity/index.html) Extract[ing Interpretable Features from Claude 3 Sonnet.](https://transformer-circuits.pub/2024/scaling-monosemanticity/index.html) _Transformer Circuits Thread_, 2024.
...
In H. Larochelle, M. Ranzato, R. Hadsell, M.F. Balcan, and H. Lin (eds.), _Advances_ _in_ _Neural_
_Information_ _Processing_ _Systems_, volume 33, pp. 12388–12401. Curran Associates, Inc., 2020,
...
_International Conference on Learning Representations_ [, 2023, Interpretability in the Wild:](https://openreview.net/forum?id=NpsVSN6o4ul) a Cir[cuit for Indirect Object Identification in GPT-2 Small.](https://openreview.net/forum?id=NpsVSN6o4ul)
...
_Meeting of the Association for Computational Linguistics_, pp. 5443–5453, Online, July 2020. Association for Computational Linguistics, Double-Hard Debias: [Tailoring](https://aclanthology.org/2020.acl-main.484) Word Embeddings for
...
Merlo, Jorg Tiedemann, and Reut Tsarfaty (eds.), _Proceedings_ _of_ _the_ _16th_ _Conference_ _of_ _the_
_European_ _Chapter_ _of_ _the_ _Association_ _for_ _Computational_ _Linguistics:_ _Main_ _Volume_, pp. 3319–
3332, Online, April 2021. Association for Computational Linguistics, Increasing [Robustness](https://aclanthology.org/2021.eacl-main.291) to
...
medical image classifiers via concept bottleneck models. _Computing_ _Research_ _Repository_,
arXiv:2310.03182, 2023.


Qinan Yu, Jack Merullo, and Ellie Pavlick. Characterizing mechanisms for factual recall in language models. In Houda Bouamor, Juan Pino, and Kalika Bali (eds.), _Proceedings_ _of_ _the_ _2023_
...
ing model to detect pneumonia in [chest](http://dx.doi.org/10.1371/journal.pmed.1002683) radiographs: A cross-sectional study. _PLOS_ _Medicine_,
...
A top-down approach to AI transparency. _Computing_ _Research_ _Repository_, arXiv:2310.01405,
2023.
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2403.19647v3_extracted/images/2403.19647v3.pdf-18-0.png)
...
of _fi_ . To fix this, we apply a stop gradient to _**ϵ**_ ( **x** ) so that **x** _[d]_ = **x** ˆ + stopgrad( **x** _[u]_ _−_ **x** ˆ).
...
_WE_ _∈_ R _[d]_ [SAE] _[×][d]_ [model] _, WD_ _∈_ R _[d]_ [model] _[×][d]_ [SAE] _,_ _bE_ _∈_ R _[d]_ [SAE] _, bD_ _∈_ R _[d]_ [model]
...
The feature vectors **v** _i_ _∈_ R _[d]_ [model] are the columns of _WD_ .
...
the difference between the model’s original CE loss and the model’s CE loss when intervening to set **x** to the reconstruction **x** ˆ. We obtain percentage of CE recovered by dividing
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2403.19647v3_extracted/images/2403.19647v3.pdf-22-0.png)
Published as a conference paper at ICLR 2025
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2403.19647v3_extracted/images/2403.19647v3.pdf-23-0.png)
Published as a conference paper at ICLR 2025



![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2403.19647v3_extracted/images/2403.19647v3.pdf-24-0.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2403.19647v3_extracted/images/2403.19647v3.pdf-24-1.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2403.19647v3_extracted/images/2403.19647v3.pdf-24-2.png)
Published as a conference paper at ICLR 2025
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2403.19647v3_extracted/images/2403.19647v3.pdf-25-0.png)
Published as a conference paper at ICLR 2025
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2403.19647v3_extracted/images/2403.19647v3.pdf-26-0.png)
Published as a conference paper at ICLR 2025
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2403.19647v3_extracted/images/2403.19647v3.pdf-27-0.png)
Published as a conference paper at ICLR 2025
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2403.19647v3_extracted/images/2403.19647v3.pdf-28-0.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2403.19647v3_extracted/images/2403.19647v3.pdf-28-1.png)
Published as a conference paper at ICLR 2025
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2403.19647v3_extracted/images/2403.19647v3.pdf-29-0.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2403.19647v3_extracted/images/2403.19647v3.pdf-29-1.png)
Published as a conference paper at ICLR 2025
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2403.19647v3_extracted/images/2403.19647v3.pdf-30-0.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2403.19647v3_extracted/images/2403.19647v3.pdf-30-1.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2403.19647v3_extracted/images/2403.19647v3.pdf-30-2.png)
Published as a conference paper at ICLR 2025
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2403.19647v3_extracted/images/2403.19647v3.pdf-31-0.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2403.19647v3_extracted/images/2403.19647v3.pdf-31-1.png)
Published as a conference paper at ICLR 2025
...
that were either uniformly sampled (random), the top 30 by IE [ˆ] from the subject-verb agreement
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2403.19647v3_extracted/images/2403.19647v3.pdf-32-0.png)
Published as a conference paper at ICLR 2025
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2403.19647v3_extracted/images/2403.19647v3.pdf-33-0.png)
Published as a conference paper at ICLR 2025
...
_Cij_ = _xi_ _· xj/_ ( _||xi||||xj||_ ) between all pairs of samples. Before performing spectral clustering,
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2403.19647v3_extracted/images/2403.19647v3.pdf-35-0.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2403.19647v3_extracted/images/2403.19647v3.pdf-35-2.png)



![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2403.19647v3_extracted/images/2403.19647v3.pdf-35-1.png)
