...
that effectively mitigates vanishing and exploding gradients. More recently, similar conditions have been applied
to derive efficient reparameterizations that ensure stability
in diagonal linear recurrent units (Orvieto et al., 2023; De
et al., 2024). In both selective and non-selective SSMs (designed in continuous-time), stability is achieved by exponential parametrization, resulting from zero-order-hold discretization techniques (Gu et al., 2021; Gu & Dao, 2023).
Finally, in LRNNs with diagonal-plus-low-rank transition
matrices, normalization arises naturally from the structure
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-1-7.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-1-8.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-1-11.png)
...
of generalized Householder transformations (Yang et al.,
2024b). Although several recent studies have examined
block-diagonal architectures, they either focus on parameterizations of non-selective models (Biegun et al., 2024;
Rusch & Rus, 2024), analyze only the stability of the statetransition matrix norm (Fan et al., 2023), or rely on architectures where this matrix is normalized by design (Yang
et al., 2024b; Walker et al., 2025), without fully addressing the problem of joint normalization of selective statetransition matrix and selective input gates, which has been
previously shown critical for sequence modeling in diagonal
LRNNs (Gu & Dao, 2023; De et al., 2024).
...
where **h** _t_ _∈_ R _[N]_ is the hidden state computed at time
...
write in closed form **h** _t_ = [�] _i_ _[t]_ =1 [(][�] _[t]_ _j_ = _t−i_ **[a]** _[j]_ [)] _[ ⊙]_ **[b]** _[i]_ _[⊙]_ **[v]** _[i]_ [.]
...
as **A** _t_ **h** _t−_ 1 instead of **a** _t_ _⊙_ **h** _t−_ 1 = diag( **a** _t_ ) **h** _t−_ 1 - can
...
denote by _h_ _[k]_ _t−_ 1 [the] _[ k]_ [-th coordinate (] _[k]_ _[∈{]_ [1] _[,]_ [ 2] _[, . . ., N]_ _[}]_ [) of]
...
As for H-LRU (Eq. 4), the block size _m_ of BD-LRU corresponds to the size of a square matrix **A** _[k]_ and _k_ _∈_ [1 _, N_ ]
...
2 _k_ _m_
Solve the equation _χ_ **A** _k_ ( _λ_ ) = det( _λI_ _−_ **A** ) = _λ_ _−_
...
_Figure_ _2._ Scaling of performance with window/block size on the compression task for L1
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-3-0.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-3-1.png)
...
_xt_ = 1 for all _t_ . For _a_ _∈_ (0 _,_ 1), as _t_ _→∞_, _ht_ converges
...
_architectures,_ _written_ _in_ _matrix_ _form_ _as_ _shown_ _in_ _Equa-_
_tions 3 and BD-LRU. If for any k_ _∈_ [1 _, N_ ] _, the k-th recur-_
_rent non-diagonal block_ **h** _[k]_ _t_ [=] **[A]** _[k]_ _t_ _[×]_ **[ h]** _t_ _[k]_ _−_ 1 [+] **[ a]** 0 _[k]_ _,t_ _[⊙]_ **[v]** _t_ _[k]_ _[is]_
...
We noticed that for moderate block sizes ( _m_ _∈_ [2 _,_ 5]), the
...
LRNNs that rely on structured parameterizations such as discretization schemes (Rusch & Rus, 2024), joint parametrization of the state-transition matrices and input gate (Biegun
et al., 2024), and exponential reparametrization (Orvieto
et al., 2023), our proposed normalization is more general
as it can be applied to variety of both non-selective and selective parameterizations. This allowed us to independently
evaluate several variants of gate parameterizations that are
defined by the function _f_ in Eq. 5. As can be seen in Fig. 2,
_our normalization strategy greatly improves performance_
of both H-LRUs and BD-LRUs.
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-5-10.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-5-13.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-6-8.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-6-9.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-6-3.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-6-10.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-7-3.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-7-4.png)
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-7-5.png)
...
Overall, we observed that our parallel scan implementation offers substantial improvements over sequential implementations, enables BD-LRUs and H-LRUs to achieve
throughput comparable to the one of linear baselines, and
effectively scales with sequence length. Our findings align
...
where **h** _i,_ **b** _i_ _∈_ R _[N]_ _,_ **A** _i_ _∈_ R _[N]_ _[×][N]_ and associative operators:
...
In many modern LRNNs, **A** _i_ is diagonal ( **c** _i,A_ - _M_ **[c]** _[j,A]_ _[∼]_
...
( **c** _i,A_ - **[c]** _[j,A]_ _[∼]_ _[N]_ [ 3][).] [However,] [if we exploit the block]



( **c** _i,A_ - _M_ **[c]** _[j,A]_ _[∼]_ _[N]_ [ 3][).] [However,] [if we exploit the block]
...
well with prior work on parallel scan implementations of
block-diagonal models. (Walker et al., 2025).
...
Chang, Y. and Bisk, Y. Language models need inductive biases to count inductively. _arXiv_ _preprint_
...
for statistical machine translation. _arXiv_ _preprint_
...
Feng, L., Tung, F., Ahmed, M. O., Bengio, Y., and Hajimirsadeghi, H. Were rnns all we needed? _arXiv_ _preprint_
...
sequences with structured state spaces. _arXiv_ _preprint_
_arXiv:2111.00396_, 2021.


Hairer, E., Wanner, G., and Nørsett, S. P. _Solving_ _ordi-_
...
Hutter, M. _Universal_ _artificial_ _intelligence:_ _Sequential_
_decisions_ _based_ _on_ _algorithmic_ _probability_ . Springer
...
Loshchilov, I. and Hutter, F. Sgdr: Stochastic gradient descent with warm restarts. _arXiv_ _preprint_
...
Okpekpe, D. and Orvieto, A. When recalling incontext, transformers are not ssms. _arXiv_ _preprint_
...
deep learning library. _Advances_ _in_ _neural_ _information_
...
_vances_ _in_ _Neural_ _Information_ _Processing_ _Systems_, 37:
30811–30849, 2024.
...
the story. _Advances_ _in_ _Neural_ _Information_ _Processing_
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-12-0.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-12-1.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-12-2.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-12-3.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-12-4.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-12-5.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-12-6.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-12-7.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-12-13.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-12-14.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-12-15.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-12-16.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-12-17.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-12-18.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-12-19.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-12-20.png)
**Improved state mixing in higher-order and block diagonal linear recurrent networks**
...
implies that the eigenvalues of state-transition matrix _|λ_ _[k]_ _i,t_ _[|]_ _[≤]_ [1][.] [Therefore,] [the product of such matrices will result in]
dynamical stability.


Next, by block-diagonality, it is sufficient to show that for all _k_ _∈_ [1 _, m_ ], _∥_ **h** _[k]_ _T_ _[∥][∞]_ _[≤]_ [max] _[t][∈]_ [[0] _[,T]_ [ ]] _[∥]_ **[v]** _t_ _[k][∥][∞]_ [.] [Let] _[ h][k]_ _i,t_ [be the] _[ i]_ [-th]
...
hence, again because [�] _j_ _[|]_ [(] _[A]_ 0 _[k]_ [)] _[i,j][|]_ _[≤]_ [1][,] _[ |][h][k]_ _i,_ 1 _[|]_ _[≤|][v]_ _i,_ _[k]_ 1 _[|]_ [, we can conclude that] _[ ∥]_ **[h]** 1 _[k][∥][∞]_ _[≤∥]_ **[v]** 1 _[k][∥][∞]_ [.] [Let us then assume by]
...
_Figure_ _7._ Scaling analysis of non-selective models on the compression task. **A** . Performance as a function of window size _m_ of
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-17-0.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-17-1.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-17-2.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-17-3.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-17-5.png)
**Improved state mixing in higher-order and block diagonal linear recurrent networks**
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-20-0.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-20-6.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-20-12.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-20-18.png)

BD-LRU m1, time step 0
...
BD-LRU m5, time step 0 BD-LRU m5, time step 1 BD-LRU m5, time step 2


BD-LRU m4, time step 0 BD-LRU m4, time step 1 BD-LRU m4, time step 2


BD-LRU m3, time step 0 BD-LRU m3, time step 1 BD-LRU m3, time step 2


BD-LRU m2, time step 0 BD-LRU m2, time step 1 BD-LRU m2, time step 2



![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-20-3.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-20-9.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-20-15.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-20-21.png)

H-LRU m1, time step 0
...
H-LRU m5, time step 0 H-LRU m5, time step 1 H-LRU m5, time step 2


H-LRU m4, time step 0 H-LRU m4, time step 1 H-LRU m4, time step 2


H-LRU m3, time step 0 H-LRU m3, time step 1 H-LRU m3, time step 2


H-LRU m2, time step 0 H-LRU m2, time step 1 H-LRU m2, time step 2



![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-20-1.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-20-7.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-20-13.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-20-19.png)

BD-LRU m1, time step 1
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-20-2.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-20-8.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-20-14.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-20-20.png)

BD-LRU m1, time step 2
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-20-4.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-20-10.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-20-16.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-20-22.png)

H-LRU m1, time step 1
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-20-5.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-20-11.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-20-17.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-20-23.png)

H-LRU m1, time step 2
...
![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-20-24.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-20-25.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-20-26.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-20-27.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-20-28.png)

![](C:/Users/cerub/OneDrive/Dokumente/LLM/Research/converted_md/2602.12021v2_extracted/images/2602.12021v2.pdf-20-29.png)
