...
The **AR (activation reconstructor, text → vector)** half of a Natural Language Autoencoder (NLA) pair,
fine-tuned from [`google/gemma-3-27b-it`](https://huggingface.co/google/gemma-3-27b-it). The
other half is [`kitft/nla-gemma3-27b-L41-av`](https://huggingface.co/kitft/nla-gemma3-27b-L41-av); both are
