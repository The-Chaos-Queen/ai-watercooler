...
def handle_mint(args: argparse.Namespace, admin_config: Dict[str, Any]) -> int:
    ...
    print()
    print(f"PowerShell: $env:WATERCOOLER_CONFIG='{config_path}'")
    return 0
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Admin helper for session-scoped Watercooler tokens.")
    ...
    mint_parser.add_argument(
        ...
        type=str,
        required=True,
        help="Principal bound to this token, for example reviewer-1.",
    )
