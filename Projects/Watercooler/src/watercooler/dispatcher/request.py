...
from ..common import WatercoolerError, load_config
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--policy", required=True, help="Explicit reviewed dispatcher policy JSON.")
    parser.add_argument("--repo-root", required=True, help="Exact Git working-tree root.")
