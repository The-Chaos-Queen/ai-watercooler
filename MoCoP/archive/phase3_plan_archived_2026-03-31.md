> **ARCHIVED 2026-03-31.** This Phase 3 plan (LoRA rank sweeps, Mamba-3 upgrade, $200-500 ablation grid) was superseded by the activation bias + DirectionalLoss pivot. Current plan lives in `EXPERIMENT_LADDER.md`. Kept for historical reference only.
