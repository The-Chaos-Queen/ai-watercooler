...
> 0 routes | 0 models | 0 components | 134 lib files | 31 env vars | 5 middleware | 0% test coverage
> **Token savings:** this file is ~13.900 tokens. Without it, AI exploration would cost ~45.400 tokens. **Saves ~31.500 tokens per conversation.**
> **Last scanned:** 2026-06-17 13:23 — re-run after significant changes
